...
<cfset btn_href1 = "http://localhost:8500/dev/lms/common_tp_details.cfm?late_lesson=#l_id#">
<cfset btn_lms1 = "Book now !">

<cfset btn_href2 = "http://localhost:8500/dev/lms/common_tp_details.cfm?late_lesson=#l_id#">
