...
<cfset email_title = "Un learner a annulé son cours">
...
<cfset btn_href1 = "https://lms.wefitgroup.com/cs_alert_cancel_adv.cfm?l_id=#l_id#">
<cfset btn_lms1 = "Voir Learners">


<cfset btn_href2 = "https://lms.wefitgroup.com/common_tp_details.cfm">
<cfset btn_lms2 = "Mon compte">
...
<cfinvoke component="components/translater" method="get_translate" returnVariable="btn_contact">
    <cfinvokeargument name="id_translate" value="btn_contact_wefit"><cfinvokeargument name="lg_translate" value="#lang#">
</cfinvoke>
