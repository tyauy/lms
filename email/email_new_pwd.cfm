...
START_RM--->
	...
	<cfif lang eq "fr">
		...
		<cfset email_subtitle = "#user_firstname# #ucase(user_lastname)#, vous souhaitez changer votre mot de passe.<br> Voici un mot de passe temporaire pour acc&eacute;der &agrave; la plateforme.">
	...
	<cfelseif lang eq "en">
		...
		<cfset email_subtitle = "#user_firstname# #ucase(user_lastname)#, this is a temporary password to connect to the platform.">
	...
	<cfelseif lang eq "de">
		...
		<cfset email_subtitle = "Dies ist Ihr temporäres Passwort">
