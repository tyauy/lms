...
<cfoutput>
	...
	<cfset email_title = #obj_translater.get_translate_complex('new_mail_trn_title', lang)#>
	<cfset email_subtitle = #obj_translater.get_translate_complex('new_mail_trn_subtitle', lang, argv)#>
...
START_RM--->
	...
	<cfif lang eq "fr">
		<cfset email_title = "Votre compte WEFIT Trainer">
		<cfset email_subtitle = "#user_firstname#, vous pouvez désormais vous connecter à l'aide de ces identifants.">
	...
	<cfelseif lang eq "en">
		<cfset email_title = "Your WEFIT Trainer account">
		<cfset email_subtitle = "#user_firstname#, from now on, you can connect to the LMS using this temporary password.">
	...
	<cfelseif lang eq "de">
		<cfset email_title = "Ihr WEFIT Trainer Profil">
		<cfset email_subtitle = "#user_firstname#, jetzt k&ouml;nnen Sie sich mit dem tempor&auml;ren Passwort in Ihr WEFIT Profil einloggen.">
