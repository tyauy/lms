...
<div class="wrapper">
	...
	<div class="main-panel">
		...
		<cfif get_quiz.quiz_type eq "lst">
			<cfset title_page = "#obj_translater.get_translate('title_page_learner_eval_lst')#">
		<cfelseif get_quiz.quiz_type eq "qpt_en">
			<cfset title_page = "#obj_translater.get_translate('title_page_learner_eval_pt')# - #obj_translater.get_translate('lang_en')#">
		<cfelseif get_quiz.quiz_type eq "qpt_de">
			<cfset title_page = "#obj_translater.get_translate('title_page_learner_eval_pt')# - #obj_translater.get_translate('lang_de')#">
		<cfelseif get_quiz.quiz_type eq "qpt_fr">
			<cfset title_page = "#obj_translater.get_translate('title_page_learner_eval_pt')# - #obj_translater.get_translate('lang_fr')#">
		<cfelseif get_quiz.quiz_type eq "qpt_es">
			<cfset title_page = "#obj_translater.get_translate('title_page_learner_eval_pt')# - #obj_translater.get_translate('lang_es')#">
		<cfelseif get_quiz.quiz_type eq "qpt_it">
			<cfset title_page = "#obj_translater.get_translate('title_page_learner_eval_pt')# - #obj_translater.get_translate('lang_it')#">
		<cfelseif get_quiz.quiz_type eq "qpt_pt">
			<cfset title_page = "#obj_translater.get_translate('title_page_learner_eval_pt')# - #obj_translater.get_translate('lang_pt')#">
		<cfelseif get_quiz.quiz_type eq "qpt_ru">
			<cfset title_page = "#obj_translater.get_translate('title_page_learner_eval_pt')# - #obj_translater.get_translate('lang_ru')#">
		<cfelseif get_quiz.quiz_type eq "qpt_zh">
			<cfset title_page = "#obj_translater.get_translate('title_page_learner_eval_pt')# - #obj_translater.get_translate('lang_zh')#">
		<cfelseif get_quiz.quiz_type eq "qpt_nl">
			<cfset title_page = "#obj_translater.get_translate('title_page_learner_eval_pt')# - #obj_translater.get_translate('lang_nl')#">
		<cfelseif get_quiz.quiz_type eq "unit">
			<cfset title_page = "#obj_translater.get_translate('title_page_learner_eou_quiz')#">
		<cfelseif get_quiz.quiz_type eq "assessment">
			<cfset title_page = "#obj_translater.get_translate('title_page_learner_assessmet_quiz')#">
		<cfelseif get_quiz.quiz_type eq "bright reading">
			<cfset title_page = "BRIGHT Reading">
		<cfelseif get_quiz.quiz_type eq "bright listening">
			<cfset title_page = "BRIGHT Listening">
		<cfelseif get_quiz.quiz_type eq "exercice">
			<cfset title_page = "Exercice">
		<cfelseif get_quiz.quiz_type eq "toeic">
			<cfset title_page = "TOEIC">
		<cfelseif get_quiz.quiz_type eq "reading_training">
