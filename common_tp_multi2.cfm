...
<div class="wrapper">
	...
	<div class="main-panel">
		...
		<div class="content">
			...
			<div id="multi_header" class="sticky-top">
			...
			<cfif get_trainer.recordCount LT 3>
				<cfif listFindNoCase("LEARNER,GUEST,TEST,CS,SALES,TRAINERMNG", SESSION.USER_PROFILE)>
										...
										<div class="col-md-12">
											<div class="p-2">
												...
												<div align="center" class="mt-4">
													<img src="./assets/img/<cfif temp eq "1">unknown_female.png<cfelse>unknown_male.png</cfif>" width="90">
													<br>
													Vous pouvez choisir jusqu'à trois formateurs.
													<br>
...
<script>
	$(document).ready(function() {
		...
		$('.btn_del_trainer').click(function(event) {	
			...
			$('#modal_body_xl').empty();	
			$('#modal_body_xl').load("<cfoutput>modal_window_tp_remove_trainer.cfm?t_id=#t_id#&u_id=#u_id#&p_id=</cfoutput>"+p_id);
		});
