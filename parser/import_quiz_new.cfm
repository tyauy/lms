...
<table style="border:1px" cellpadding="3" cellspacing="3">
	...
	<cfset mapping_id = listgetat(temp,1,"_")>
    mapping_id == #mapping_id#
	<cfset q_name = listgetat(temp,2,"_")>
	...
	<cfif get_check.recordcount eq "0"> --->
		...
		<!--- <cfoutput>>>>>> #vartemp#</cfoutput> --->
		<cfloop list="#vartemp#" index="encours" delimiters="#chr(13)##chr(10)#">

            <!--- <cfoutput>>>>>> #listlen(encours,"|")#</cfoutput> --->
...
<div align="center"><a href="import_quiz_new.cfm?oktreat=1">Int&eacute;grer QUIZ</a></div>