...
<cfdirectory action="list" directory="/home/www/winegroup/www/manager/lms3/parser/quiz_togo/" recurse="false" name="myList" sort="name ASC">
...
<table style="border:1px" cellpadding="3" cellspacing="3">
	...
	<cfset quiz_id = "983">
		...
		<cffile action="read" file="/home/www/winegroup/www/manager/lms3/parser/quiz_togo/#myList.name#" variable="vartemp" charset="windows-1252">
		...
		<cfif listlen(encours,"|") eq "10">
			...
			<cfif qu_id neq " ">
				...
				<cfset qu_text2 = #replacenocase(listgetat(encours,5,'|'),'"','','ALL')#>
				<cfset qu_timer = #replacenocase(listgetat(encours,6,'|'),'"','','ALL')#>
				
				<cfset qu_ans = #replacenocase(listgetat(encours,7,'|'),'"','','ALL')#>
				<cfset qu_good = #replacenocase(listgetat(encours,8,'|'),'"','','ALL')#>
				<cfset qu_anstype = #replacenocase(listgetat(encours,9,'|'),'"','','ALL')#>
				...
				<tr>
					...
					<td style="background-color:##ECECEC">qu_text2</td>
				...
				<cfqueryparam cfsqltype="cf_sql_varchar" value="#qu_text2#">,
				<cfqueryparam cfsqltype="cf_sql_varchar" value="#qu_title#">,
				<cfqueryparam cfsqltype="cf_sql_varchar" value="#qu_anstype#">,
				<cfqueryparam cfsqltype="cf_sql_integer" value="300">,
				<cfqueryparam cfsqltype="cf_sql_varchar" value="#qu_category#">
				)
				</cfquery>
...
<cfif isdefined("oktreat")>
<cffile action="move" source="/home/www/winegroup/www/manager/lms3/parser/quiz_togo/#myList.name#" destination="/home/www/winegroup/www/manager/lms3/parser/quiz_ok/" charset="windows-1252">
</cfif>
...
<div align="center"><a href="import_quiz_toeic.cfm?oktreat=1">Int&eacute;grer QUIZ</a></div>
