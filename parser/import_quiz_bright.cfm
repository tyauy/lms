...
<table style="border:1px" cellpadding="3" cellspacing="3">
	...
	<!---<cfset quiz_id = "1125">--->
		...
		<cfif isdefined("oktreat")>
				...
				VALUES
				(
				<cfqueryparam cfsqltype="cf_sql_varchar" value="Test Bright Français - Compréhension écrite">,
				30,
				30,
				'bright reading'
				)
...
<!---
<cfif isdefined("oktreat")>
<cffile action="move" source="/home/www/wnotedev1/www/manager/lms/parser/quiz_togo/#myList.name#" destination="/home/www/wnotedev1/www/manager/lms/parser/quiz_ok/" charset="utf-8">
</cfif>
--->
...
<div align="center"><a href="import_quiz_bright.cfm?oktreat=1">Int&eacute;grer QUIZ</a></div>
