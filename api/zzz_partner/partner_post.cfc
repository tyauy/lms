   ...
   <cffunction name="insert_user" access="remote" httpMethod="post" returntype="any" returnformat="plain">
    ...
    <cffunction name="switch_user" access="remote" httpMethod="post">
        ...
        <cfquery name="get_lessons" datasource="#SESSION.BDDSOURCE#">
            SELECT l.lesson_id, l.lesson_start, l.lesson_end, l.planner_id, l.lesson_duration, u2.user_email
            FROM lms_lesson2 l
        ...
        <cfoutput query="get_lessons" group="planner_id">
            ...
            <cfmail from="WEFIT <service@wefitgroup.com>" to="#user_email#" bcc="rremacle@wefitgroup.com,trainer@wefitgroup.com" subject="#subject#" type="html" server="localhost">
