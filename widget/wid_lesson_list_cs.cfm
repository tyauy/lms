...
<cfif show_tab eq "0">
	...
	<cfoutput query="get_lesson_status">
		...
		<cfelse>
			<cfset "get_lesson_#status_id#" = obj_query.oget_lessons(st_id="#status_id#",pmissed="#pmissed#")>
		</cfif>
...
<cfelseif show_tab neq "0" AND show_tab neq "week" AND show_tab neq "today">
	...
	<cfif isdefined("period_month")>
		<cfset "get_lesson_#show_tab#" = obj_query.oget_lessons(st_id="#show_tab#",period_month="#period_month#",pmissed="#pmissed#")>
	<cfelse>
		<cfset "get_lesson_#show_tab#" = obj_query.oget_lessons(st_id="#show_tab#",pmissed="#pmissed#")>
	</cfif>	
...
<cfelseif show_tab eq "week">
	...
	<cfset get_lesson_week = obj_query.oget_lessons(start_range="#mondayDate#",end_range="#sundayDate#",pmissed="#pmissed#")>
		
<cfelseif show_tab eq "today">
			
	<cfset get_lesson_week = obj_query.oget_lessons(start_range="#now()#",end_range="#now()#",pmissed="#pmissed#")>
...
<div class="tab-content" id="myTabContent">
	...
	<cfif show_tab eq "0">
	<div class="tab-pane fade <cfif get_lesson_status.status_id eq st_id>show active</cfif>" <cfoutput>id="tab_#tpcor#_#get_lesson_status.status_id#"</cfoutput> role="tabpanel" aria-labelledby="home-tab" id="title_<cfoutput>#status_id#</cfoutput>">
	</cfif>
