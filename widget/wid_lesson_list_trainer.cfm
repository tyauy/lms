...
<cfif show_tab eq "0">
	...
	<cfoutput query="get_lesson_status">
		...
		<cfif isdefined("period_month")>
			<cfset "get_lesson_#status_id#" = obj_query.oget_lessons(p_id="#SESSION.USER_ID#",st_id="#status_id#",period_month="#period_month#")>
		<cfelse>
			<cfset "get_lesson_#status_id#" = obj_query.oget_lessons(p_id="#SESSION.USER_ID#",st_id="#status_id#")>
		</cfif>
...
<cfelseif show_tab neq "0" AND show_tab neq "week" AND show_tab neq "today">
	...
	SELECT status_id, status_name_fr as status_name, status_css, status_bootstrap FROM lms_lesson_status UNION (SELECT 0 as status_id, "#obj_translater.get_translate('global_all')#" as status_name, "" as status_css, "" as status_bootstrap) ORDER BY status_id
	</cfquery>
	
	<cfif isdefined("period_month")>
		<cfset "get_lesson_#show_tab#" = obj_query.oget_lessons(p_id="#SESSION.USER_ID#",st_id="#show_tab#",period_month="#period_month#")>
	<cfelse>
		<cfset "get_lesson_#show_tab#" = obj_query.oget_lessons(p_id="#SESSION.USER_ID#",st_id="#show_tab#")>
	</cfif>
...
<cfelseif show_tab eq "week">
	...
	<cfset get_lesson_week = obj_query.oget_lessons(p_id="#SESSION.USER_ID#",start_range="#mondayDate#",end_range="#sundayDate#")>
		
<cfelseif show_tab eq "today">
			
	<cfset get_lesson_week = obj_query.oget_lessons(p_id="#SESSION.USER_ID#",start_range="#now()#",end_range="#now()#")>
...
<div class="tab-content" id="myTabContent">
	...
	<!--- <cfdump var="#evaluate("get_lesson_#status_id##"> --->
		...
		<div class="row">
			<div class="col-md-12" style="margin-top:25px">
				...
				<table class="table table-hover">
					...
					<cfinclude template="./tab_lesson_trainer_list.cfm">
