...
<div class="wrapper">
	...
	<div class="main-panel">
		...
		<div class="content">
            ...
            <div class="d-flex">
                <div class="p-3 cursored rounded-top border-top border-left border-right bg-white" data-toggle="collapse" data-target="#div_visio" aria-expanded="true" aria-controls="div_visio" style="z-index:1 !important">
                    <h5 class="d-inline"><i class="fa-thin fa-webcam <!---<cfif evaluate("SESSION.ACCESS_#ucase(cor)#") eq "1">text-red</cfif>---> fa-lg mr-1"></i> <cfoutput>#obj_translater.get_translate('card_title_visio')#</cfoutput></strong></h5>
                    <!--- <hr class="<cfif evaluate("SESSION.ACCESS_#ucase(cor)#") eq "1">border-red<cfelse>border-top</cfif> mb-1 mt-2"> --->
                </div>

                <div class="p-3 cursored" data-toggle="collapse" data-target="#div_vc" aria-expanded="false" aria-controls="div_vc">
                ...
                <div class="p-3 cursored" data-toggle="collapse" data-target="#div_el" aria-expanded="false" aria-controls="div_el">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-12">
                    <div class="card bg-white border p-3" style="margin-top:-1px !important; z-index:0 !important">
                        ...
                        <div class="mt-3">
                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                <div class="rounded-top border-top border-left border-right border-red bg-light m-0 pt-2 pb-1 px-3">
                                    ...
                                    <i class="fa-light  fa-lg mr-1 text-red"></i> Next activity
                                    </strong>
                                </div>
                            ...
                            <div class="shadow-sm rounded-bottom border border-red m-0 w-100 bg-light" style="min-height:250px; margin-top:-1px !important">
                               
                                <div class="card-body">
                        
                                    <div id="heading_302944" class="row">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="card">
                                                    ...
                                                    <img src="../assets/img_material/1183.jpg" class="card-img-top">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="d-flex justify-content-center">
                                                        ...
                                                        <img src="https://lms.wefitgroup.com/assets/user/5373/photo.jpg" width="32" class="border_thumb" title="KRYSTINA">
                                        ...
                                        <div class="col-md-8">
                                            ...
                                            <div class="d-flex flex-column h-100">
                                                ...
                                                <div>
                                                    <h6 class="m-0">Discussion lesson </h6>
                                                </div>
                                            
                                                <div>
                                                    <p class="mt-2">
                        
                                                        <small>This lesson  is oriented towards oral expression and comprehension.</small>
                                                ...
                                                <div class="mt-auto w-100">
                                                        ...
                                                        <div class="d-flex justify-content-end align-items-end">
                                                            <span class="badge badge-pill bg-red border border-red text-white px-2 py-2 font-weight-normal" id="pill_336926" style="font-size:14px">
                                                            <i id="i_336926" class="fa-light fa-calendar-alt text-white"></i>
                                                            <strong>fri 16/06 - 12:45</strong>
                                                            </span>
                                                        </div>
                                                        ...
                                                        <div class="d-flex justify-content-end align-items-end">
                                                            ...
                                                            <div>
                                                                <button class="btn btn-outline-red btn_view_lesson font-weight-normal" id="cancel_336926" data-tid="48384" data-lid="336926" data-levelalias="" data-lduration="75">
                                                                    Cancel
                                                                </button>
                                                            </div>
                        
                                                            <div>
                                                                <button class="btn btn-red btn_launch_lesson font-weight-normal" id="l_336926">
                                                                Launch lesson
                                                                </button>
                                                            </div>
