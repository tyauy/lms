...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="main-panel">
            ...
            <cfset title_page = "ELEARNING - VOCABULARY">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="nav nav-tabs">
                            <button class="nav-link active" type="button" onclick="document.location.href='el_vocab.cfm'">Listes de<br><strong>Vocabulaire</strong></button>
                            <button class="nav-link" type="button" onclick="document.location.href='el_vocab_perso.cfm'">Vocabulaire<br><strong>"Favoris"</strong></button>
                        </div>
                        ...
                        <div class="card border mt-3">
                            ...
                            <div class="card-body">
                                ...
                                <cfoutput>
                                    <p class="mt-2">#obj_translater.get_translate_complex('intro_vocablist')#</p>
                                </cfoutput>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <cfoutput><a target="_blank" href="./tpl/el_vocablist_container.cfm?voc_cat_id=#cat_id#&lang_select=#lang_select#&lang_select_id=#lang_select_id#&<cfif isdefined("lang_translate")>&lang_translate=#lang_translate#</cfif>" class="btn btn-outline-red float-right"><i class="fad fa-file-pdf btn_export_list" id="export_#cat_id#"></i> #obj_translater.get_translate('btn_export')#</a></cfoutput>
