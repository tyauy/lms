<cfoutput>
    ...
    <!--- <cfif elearning_completion neq "0.0" AND elearning_completion neq "">
            ...
            <div class="d-flex">
                ...
                <div>
                    <h6 class="m-0">
                        <div>
                            ...
                            <h6 class="mb-0 text-#level_alias#" style="font-size:18px !important">#module_name_clear#</h6>
                        </div>
                        #sessionmaster_name#
                    </h6>
                    ...
                    <p class="mt-2">
                        ...
                        <cfif sessionmaster_objectives neq ""><small><strong>#obj_translater.get_translate('table_th_course_objectives')#<cfif SESSION.LANG_CODE eq "fr"> :<cfelse>:</cfif></strong> #sessionmaster_objectives#</small></cfif>
                ...
                <div class="d-flex ml-auto align-items-end flex-column justify-content-end h-100">
                    ...
                    <div class="mt-4 d-flex">
                        ...
                        <a class="btn btn-#level_css# m-0" href="el_play_sco.cfm?sco=#elearning_module_id#" target="_blank" data-mid="#elearning_module_id#" data-smid="#sessionmaster_id#">
                        
                            <cfif elearning_progress gt "90">
                                <div class="triangle_tiny triangle_#level_alias#"></div>
                                <i class="fa-sharp fa-light fa-check text-white triangle_check_tiny fa-xs"></i>
                            </cfif>
                    ...
                    <cfif directoryExists("#SESSION.BO_ROOT#/assets/scorm/#elearning_module_path#_warmup") OR directoryExists("#SESSION.BO_ROOT#/assets/scorm/#elearning_module_path#_practice")>
                    <div class="d-flex mt-2">

                        <div>
                            <small><strong>#obj_translater.get_translate('btn_more_content')#<cfif SESSION.LANG_CODE eq "fr"> :<cfelse>:</cfif></strong></small>
                        </div>
                        <div><!----------- WARM UP MANAGER ------------>
                            <cfif directoryExists("#SESSION.BO_ROOT#/assets/scorm/#elearning_module_path#_warmup")>
    
                                <cfquery name="get_module_id" datasource="#SESSION.BDDSOURCE#">
                                SELECT em.elearning_module_id, emu.elearning_completion
                                FROM lms_elearning_module em
                                LEFT JOIN lms_elearning_module_user emu ON emu.elearning_module_id = em.elearning_module_id AND emu.user_id = <cfqueryparam cfsqltype="cf_sql_integer" value="#SESSION.USER_ID#">
                                WHERE elearning_module_path = <cfqueryparam cfsqltype="cf_sql_varchar" value="#elearning_module_path#_warmup">
                                </cfquery>
    
                                <a class="btn btn-link m-0 p-0 text-#level_css# ml-2" href="el_play_sco.cfm?sco=#get_module_id.elearning_module_id#" target="_blank" data-mid="#get_module_id.elearning_module_id#" data-smid="#sessionmaster_id#">
                                    [Warm-up]									
                                </a>
                            </cfif>
                        </div>
                        ...
                        <div>
                            <cfif directoryExists("#SESSION.BO_ROOT#/assets/scorm/#elearning_module_path#_practice")>

                                <cfquery name="get_module_id" datasource="#SESSION.BDDSOURCE#">
                                SELECT em.elearning_module_id, emu.elearning_completion
                                FROM lms_elearning_module em
                                LEFT JOIN lms_elearning_module_user emu ON emu.elearning_module_id = em.elearning_module_id AND emu.user_id = <cfqueryparam cfsqltype="cf_sql_integer" value="#SESSION.USER_ID#">
                                WHERE elearning_module_path = <cfqueryparam cfsqltype="cf_sql_varchar" value="#elearning_module_path#_practice">
                                </cfquery>
