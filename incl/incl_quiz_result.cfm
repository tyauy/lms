		...
		<tr bgcolor="<cfoutput>###color_tr#"</cfoutput>">
			...
			<td>
				...
				<cfelseif get_question.qu_category_id eq 5>
					<i class="fal fa-books fa-lg" aria-hidden="true" title="#get_question.category_name#"></i>
				<cfelseif get_question.qu_category_id eq 6>
					[Part 1]
				<cfelseif get_question.qu_category_id eq 7>
					[Part 2]
				<cfelseif get_question.qu_category_id eq 8>
					[Part 3]
				<cfelseif get_question.qu_category_id eq 9>
					[Part 4]
				<cfelseif get_question.qu_category_id eq 10>
					[Part 5]
				<cfelseif get_question.qu_category_id eq 11>
					[Part 6]
				<cfelseif get_question.qu_category_id eq 12>
					[Part 7]
				</cfif>
				</cfoutput>
			</td>
			...
			WHERE qu_id = <cfqueryparam cfsqltype="cf_sql_integer" value="#qu_id#">
				...
				<cfloop from="1" to="#get_sub.nbsub#" index="sub_id">	
					<tr bgcolor="<cfoutput>###color_tr#"</cfoutput>">
						...
						<cfif not isdefined("display_result_lst")>
							<cfoutput query="get_result">
								<!---<span class="label label-success">Valorisation</span><br>--->
								<cfif ans_gain neq "">
									<h6><span class="badge badge-pill badge-primary bg-success">+#ans_gain#</span></h6>
								<cfelse>
									<h6><span class="badge badge-pill badge-secondary">+0</span></h6>
								</cfif>
							</cfoutput>
						<cfelse>
							<cfoutput query="get_result"><h6><span class="badge badge-pill badge-primary bg-success">+#ans_flag#</span></h6></cfoutput>
						</cfif>
						</td>--->
...
<!--- <cfoutput>total_quiz_score = #list_quiz_score#	</cfoutput> --->
	...
	var barChartData = {
		...
		<cfelseif qu_category_id eq 6>
			'Part 1 (#listgetat(list_quiz_score,currentrow)#%)',
		<cfelseif qu_category_id eq 7>
			'Part 2 (#listgetat(list_quiz_score,currentrow)#%)',
		<cfelseif qu_category_id eq 8>
			'Part 3 (#listgetat(list_quiz_score,currentrow)#%)',
		<cfelseif qu_category_id eq 9>
			'Part 4 (#listgetat(list_quiz_score,currentrow)#%)',
		<cfelseif qu_category_id eq 10>
			'Part 5 (#listgetat(list_quiz_score,currentrow)#%)',
		<cfelseif qu_category_id eq 11>
			'Part 6 (#listgetat(list_quiz_score,currentrow)#%)',
		<cfelseif qu_category_id eq 12>
			'Part 7 (#listgetat(list_quiz_score,currentrow)#%)',
		</cfif>
		</cfoutput>],
		datasets: [{
			label: 'Dataset 1',
