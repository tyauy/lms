...
<div class="wrapper">
	...
	<div class="main-panel">
        ...
        <div class="container-fluid">
          ...
          <!-- Add task button -->
          <button id="add_task_button" class="btn btn-primary mt-3"><i class="fas fa-plus"></i> Add New Task</button>
          ...
          <div class="row mt-4">
              ...
              <!-- Right column: TinyMCE editor (1/3 width) -->
              <div class="col-md-4">
                  <h4>Edit Task</h4>
                  <textarea id="task_explanation_long"></textarea>
