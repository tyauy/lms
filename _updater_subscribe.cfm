<cfif isdefined("form.user_email") AND isdefined("form.user_password") AND isdefined("form.user_name") AND isdefined("form.user_firstname") AND isdefined("form.user_phone")>
...
<cfif isdefined("user_cpf")><cfqueryparam cfsqltype="cf_sql_varchar" value="#user_cpf#">,<cfelse>3,</cfif>
<cfif isdefined("user_search")><cfqueryparam cfsqltype="cf_sql_varchar" value="#user_search#"><cfelse>'NC'</cfif>
)
</cfquery>
