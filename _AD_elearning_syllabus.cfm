                ...
                <div class="row">
                    ...
                    <div class="col-md-8 col-sm-12">
                        ...
                        <!--- <cfdump var="#dirQuery#"> --->
                            ...
                            SELECT sm.sessionmaster_name, sm.sessionmaster_id, sessionmaster_code, 
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex">
                                    ...
                                    <div class="w-100 ml-2">
                                        ...
                                        <h5 class="d-inline"> #sessionmaster_name#</h5>
                                        ...
                                        <div class="border-top p-2">
                                            ...
                                            <div class="float-left"> 
                                                <cfif fileexists("#SESSION.BO_ROOT#/assets/img_material/#sessionmaster_code#.jpg")>			
                                                    <img src="../assets/img_material/#sessionmaster_code#.jpg" width="60" align="left">
                                                <cfelseif fileexists("#SESSION.BO_ROOT#/assets/img_material/#sessionmaster_id#.jpg")>			
                                                    <img src="../assets/img_material/#sessionmaster_id#.jpg" width="60" align="left">
                                                <cfelse>
                                                    <img src="../assets/img/wefit_lesson.jpg" width="60" align="left">
                                                </cfif>
                                            ...
                                            <div class="float-right">    
                                                ...
                                                <a class="btn btn-sm btn-outline-#module_level#" href="el_play_sco.cfm?sco=#sessionmaster_id#" target="_blank">
