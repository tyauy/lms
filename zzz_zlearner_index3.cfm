				...
				<div class="card h-100 <cfif evaluate("SESSION.ACCESS_#ucase(cor)#") eq "1">border<cfelse>bg-light</cfif>">
					<div class="card-body pb-0">
						...
						<div class="d-flex">
							...
							<div align="left">
								<h5 style="font-size:20px" class="mb-0">
						...
						<cfif evaluate("SESSION.ACCESS_#ucase(cor)#") eq "1">
								...
								<!---<div class="d-flex justify-content-between">
									<div class="rounded-top border-top border-left border-right bg-light m-0 pt-2 pb-1 px-3">
										<strong class="text-info">
										<i class="fa-light fa-map-location fa-lg mr-1 text-info"></i> <cfoutput>#obj_translater.get_translate("sidemenu_learner_tp")#</cfoutput>
										</strong>
									</div>
								</div>
								
								<!---<div class="shadow-sm rounded-bottom border m-0 w-100 bg-light p-3 mb-3" style="margin-top:-1px !important">--->
			...
			--->
								...
								<div class="p-3 mb-3">
									...
									<cfif tp_status_id neq "3" AND tp_status_id neq "">
										...
										<div class="d-flex justify-content-between align-items-end">
											...
											<div align="right">
												<a class="btn btn-sm btn-outline-info m-0 mt-2" href="./common_tp_details.cfm?t_id=#tp_id#">#ucase(obj_translater.get_translate("global_details"))#</a>
											</div>
								...
								<cfelse>
									...
									<div class="d-flex justify-content-between">
										...
										<div class="rounded-top border-top border-left border-right <!---border-info---> bg-light m-0 pt-2 pb-1 px-3">
											<strong class="text-info">
											<i class="fa-light fa-forward fa-lg mr-1 text-info"></i> <cfoutput>#obj_translater.get_translate('card_learner_nextlesson')#</cfoutput>
											</strong>
										</div>
									</div>
									<div class="shadow-sm rounded-bottom border <!---border-info---> m-0 w-100 bg-light" style="margin-top:-1px !important">
										<div class="card-body">
											...
											<br><br>
											<a class="btn btn-info m-0" href="./common_tp_details2.cfm"><cfoutput>#ucase(obj_translater.get_translate('btn_book_short'))#</cfoutput></a>
											</div>
										</div>
									</div>
							...
							<cfelse>
								...
								<div align="center">
									...
									<br>
									<a class="btn btn-sm btn-info m-0 mt-2 btn_contact_wefit"><cfoutput>#obj_translater.get_translate('btn_contact_wefit')#</cfoutput></a>
								</div>	
					...
					<div class="card-body">
							...
							<cfoutput query="get_tp_el">
								<div class="<!---shadow-sm rounded-bottom border m-0 w-100 bg-light --->p-3 mb-3" style="margin-top:-1px !important">
									<div class="d-flex justify-content-between align-items-end">
										...
										<div>
											<a class="btn btn-sm btn-outline-info m-0" href="learner_virtual.cfm"><cfoutput>#ucase(obj_translater.get_translate("vc_btn_manage_tp"))#</cfoutput></a>
										</div>
									</div>
								</div>
							</cfoutput>
								...
								<div class="shadow-sm rounded-bottom border border-top m-0 w-100 bg-light" style="margin-top:-1px !important">
									<div class="card-body">
										<div align="center">
											<cfoutput>#obj_translater.get_translate('alert_visio_no_nextlesson')#</cfoutput>
										<br><br>
										<a class="btn btn-info m-0" href="./learner_virtual.cfm"><cfoutput>#ucase(obj_translater.get_translate('btn_book_short'))#</cfoutput></a>
										</div>
									</div>
								</div>
						...
						<cfelse>
							...
							<div align="center">
								...
								<br>
								<a class="btn btn-sm btn-outline-info btn_discover_virtualclass m-0 mt-2"><cfoutput>#ucase(obj_translater.get_translate('btn_more_info'))#</cfoutput></a>
								<a class="btn btn-sm btn-info m-0 mt-2 btn_contact_wefit"><cfoutput>#obj_translater.get_translate('btn_contact_wefit')#</cfoutput></a>
							</div>	
							...
							<cfoutput query="get_tp_el">
								<div class="<!---shadow-sm rounded-bottom border m-0 w-100 bg-light --->p-3 mb-3" style="margin-top:-1px !important">
									<div class="d-flex justify-content-between align-items-end">
										...
										<div>
											<a class="btn btn-sm btn-outline-info m-0" href="el_dashboard.cfm"><cfoutput>#ucase(obj_translater.get_translate("btn_el_access"))#</cfoutput></a>
										</div>
									</div>
								</div>
							</cfoutput>
					...
					<div class="card-body">
						...
						<cfelse>
							...
							<div align="center">
								...
								<br>
								<a class="btn btn-sm btn-outline-info m-0 mt-2" href="https://formation.wefitgroup.com">WEFIT SHOP</a>
								<a class="btn btn-sm btn-info m-0 mt-2 btn_contact_wefit"><cfoutput>#obj_translater.get_translate('btn_contact_wefit')#</cfoutput></a>
							</div>	
