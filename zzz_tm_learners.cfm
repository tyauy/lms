...
SELECT user_type_id, user_type_name_#SESSION.LANG_CODE# as user_type_name FROM user_type WHERE user_type_id IN (3,4,5,8) 
</cfquery>
...
<cfparam name="tselect" default="#month(now())#_#year(now())#">
<cfset msel = listgetat(tselect,1,"_")>
<cfset ysel = listgetat(tselect,2,"_")>
			...
			<div class="row justify-content-md-center mt-3 mb-1">
				<div class="col-xl-10 col-lg-12">
					...
					<cfoutput>
						...
						<a class="btn btn-link <cfif display eq "activity">text-info</cfif>" href="tm_learners.cfm?display=activity" data-toggle="tooltip" data-placement="top" title="#obj_translater.get_translate("tooltip_display_activity")#"><i class="fal fa-road fa-2x"></i></a>
