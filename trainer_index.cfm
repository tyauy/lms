	...
	<div class="main-panel">
		...
		<div class="content">
			...
			<div class="row">
				...
				<cfif Day(currentDate) GT (DaysInMonth(currentDate) - 10)>
				<cfoutput>
					<div class="container">
					<div class="alert alert-danger">
						#obj_translater.get_translate('trainer_complete_ln_warning')#
					</div>
					</div>
				</cfoutput>
				</cfif>
				...
				<div class="col-lg-4 col-md-4 col-sm-6 mb-2">
					<div class="card card-stats h-100 border-top border-red">
						<div class="card-body">
							<div class="row">
								...
								<div class="col-4 col-md-3">
									...
									<i class="fa-light fa-calendar-alt text-red fa-2x"></i>
									</div>
								</div>
							</div>
						</div>
						<div class="card-footer" style="text-align:right;">
							...
							<a href="##" class="btn btn-sm btn-red btn_next_lesson"><cfoutput>#obj_translater.get_translate('btn_launch_short')#</cfoutput></a>
							</cfif>
							<cfelse>
							<hr>
				...
				<div class="col-lg-4 col-md-4 col-sm-6 mb-2">
					<div class="card card-stats h-100 border-top border-warning">
						<div class="card-body">
							<div class="row">
								<div class="col-8 col-md-9">
									<div class="text-left">
								...
								<div class="col-4 col-md-3">
									<div class="text-center">
									<i class="fa-light fa-webcam text-warning fa-2x"></i>
									</div>
								</div>
							</div>
							<div class="row">
						...
						<div class="card-footer" style="text-align:right">
							<hr>
							<div class="stats">
							    <a href="common_trainer_account.cfm" class="btn btn-sm btn-outline-warning d-inline-block <cfif SESSION.USER_STATUS_ID neq "4" AND SESSION.USER_STATUS_ID neq "6">disabled</cfif>"><cfoutput>#obj_translater.get_translate('sidemenu_trainer_settings')#</cfoutput></a>
                            </div>
						</div>
					</div>
				</div>
