...
<cfparam name="formation_id" default="0">
...
<cfif type eq "learner">
	...
	<cfif isdefined("formation_id") AND formation_id neq "0">
	 and t.formation_id = <cfqueryparam cfsqltype="cf_sql_integer" value="#formation_id#">
	</cfif>
...
<div class="wrapper">
	...
	<div class="main-panel">
		...
		<div class="content">
			...
			<select class="form-control" name="group" onchange="document.location.href='cs_notation.cfm?g_id='+$(this).val()">
				<option value="0" <cfif g_id eq "0">selected</cfif>>---Select Group---</option>
				<cfoutput query="get_account_group">
				<option value="#group_id#">#group_name# [#nb#]</option>
				</cfoutput>
			</select>
			<select class="form-control" name="group" onchange="document.location.href='cs_notation.cfm?formation_id='+$(this).val()">
				<option value="0" <cfif formation_id eq "0">selected</cfif>>---Select Language---</option>
				<cfoutput query="get_formation_lang">
				<option value="#formation_id#"  <cfif formation_id eq get_notation.formation_id>selected</cfif>>#formation_name#</option>
				</cfoutput>
			</select>
			<cfif type eq "learner">
				<br><br>
				<select class="form-control" name="group" onchange="document.location.href='cs_notation.cfm?type=learner&t_id='+$(this).val()">
					...
					<cfif type eq "learner">
						...
						<div class="table-responsive" style="max-height: 500px;">
							...
							<tr>
								...
								<td><a href="crm_account_edit.cfm?a_id=#account_id#">#account_name#</a>
									<br>
								<cfif SESSION.USER_PROFILE neq "trainer"><a href="common_learner_account.cfm?u_id=#user_id#">#user_firstname# #ucase(user_name)#</a><cfelse>-</cfif></td>
								<td><a href="common_trainer_account.cfm?u_id=#trainer_id#">#trainer_firstname#</a></td>
								<td><small>#sessionmaster_name#</small></td>
								<td data-lang="#user_ready_go.formation_code#"><cfloop query="user_ready_go"><span class="lang-sm" lang="#lcase(user_ready_go.formation_code)#"></span></cfloop></td>
