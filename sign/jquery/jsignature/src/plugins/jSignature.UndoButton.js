				...
				if (this.settings[extensionName]) {
					...
					if (typeof oursettings !== 'function') {
						...
						oursettings = function(){
							...
							, $undoButton = $('<input type="button" value="Effacer Dernier Trait" class="btn btn-xs btn-warning" style="position:absolute;display:none;margin:0 !important;top:auto" />')
