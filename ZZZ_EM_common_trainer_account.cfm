                            ...
                            <div class="row justify-content-middle">
                                ...
                                <div class="col-lg-3 pt-3" align="center">
                                    ...
                                    <cfif listFindNoCase("CS,SALES,FINANCE,TRAINERMNG", SESSION.USER_PROFILE)>
                                        ...
                                        <cfif listFindNoCase("CS,SALES,FINANCE,TRAINERMNG", SESSION.USER_PROFILE) AND isdefined("SESSION.USER_ISMANAGER") AND SESSION.USER_ISMANAGER eq "1">
                                    ...
                                    <cfif listFindNoCase("CS,SALES,FINANCE,TRAINERMNG", SESSION.USER_PROFILE)>
                                        ...
                                        <div class="table table-bordered bg-white">
                                            <div class="row bg-light text-dark m-0">
                                              ...
                                              <div class="col p-0"><small><strong>B2B</strong></small></div>
                                              <div class="col p-0"><small><strong>B2C</strong></small></div>
                                ...
                                <div class="col-lg-3 mb-2" align="center">
                                    ...
                                    <table class="table table-bordered table-sm bg-white mb-4">
                                        <tr>
                                            ...
                                            <th><button class="btn btn-info btn-sm btn_trainer_edit my-0" id="edit_techno"><i class="fal fa-edit"></i></button></th>
                                        </tr>
                                        ...
                                        <cfloop query="get_techno_list">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center"><a id='#get_techno_list.user_techno_link#' class="btn btn-sm btn-info markup-copy">copy link</td>
                                            </tr>
											...
											<tr>
												<td valign="top">
													<div class="row">
														...
														<cfset dir_go = "#SESSION.BO_ROOT#/assets/user_doc/#u_id#/">
															...
															<table class="table table-sm table-bordered" id="file_holder">
																...
																<cfelse>
																	...
																	<tr id="file_#dirQuery.currentRow#">
																		...
																		<td colspan="2">
																		<a href="./assets/user_doc/#u_id#/#name#" target="_blank">
															...
															<table class="table table-sm table-bordered">
																...
																<tr>
																	...
																	<td>
																		...
																		<input type="hidden" name="dir_go" value="<cfoutput>#SESSION.BO_ROOT#/assets/user_doc/#u_id#</cfoutput>">
                                ...
                                <div id="trainer_contracts" class="collapse" data-parent="#accordion">
                                    ...
                                    <table class="table table-sm">
                                        <tr>
                                            ...
                                            <td>
                                                <div class="float-right"><a class="btn btn-info btn-sm btn_trainer_edit_charter my-0" href="trainer_sign.cfm?view=trainer_charter"><i class="fal fa-edit"></i></a></div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="float-right"><a class="btn btn-info btn-sm btn_trainer_edit_contract my-0" href="trainer_sign.cfm?view=trainer_contract"><i class="fal fa-edit"></i></a></div>
			...
			success    : function ( data )
			{
				...
				setTimeout(function (){
					...
					if (!obj.FILEWASOVERWRITTEN) {
						...
						new_doc += '<a href="./assets/user_doc/<cfoutput>#u_id#</cfoutput>/'+ obj.CLIENTFILE + '" target="_blank">'+ obj.CLIENTFILE + '</a>';
						<!--- <a href="##" onclick="if(confirm('Supprimer le fichier ?')){document.location.href='updater_upload_admin.cfm?doc_delete=#name#&n_doc=#n_doc#&a_id=#a_id#&o_id=#o_id#<cfif isDefined("u_id")>&u_id=#u_id#</cfif><cfif isDefined("ucb")>&ucb=#ucb#</cfif>&from=#from#'}" class="btn pull-right btn-sm btn-danger"><i class="fas fa-times"></i></a> --->
