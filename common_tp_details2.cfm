                                ...
                                <div class="card border">
                                    <div class="card-body pb-0">
                                            ...
                                            <div>
                                                ...
                                                <h5 class="d-inline"> #obj_translater.get_translate('card_title_visio')# #get_tp.formation_name# 20h
                                                    ...
                                                    <cfloop query="tp_trainer">
                                                        <span class="badge badge-pill border bg-light p-2 pr-3 font-weight-normal" id="pill_215209" style="font-size:16px">
                                                            <div class="d-flex">
                                                                <div>
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <cfif (listFindNoCase("1,2,3,4", get_tp.formation_id)) AND get_tp.method_id neq "11">
                                                                        <cfif !listFindNoCase("TRAINER,TEST", SESSION.USER_PROFILE) AND (listFindNoCase("1,2,10", get_tp.tp_status_id)) AND get_tp.method_id neq "2">
                                                                            <a class="btn btn-sm btn-link text-red btn_del_trainer m-0 p-0 pt-1" <cfif tp_trainer.recordCount lte 1>disabled</cfif> id="trainer_#planner_id#" >#obj_translater.get_translate("btn_remove")# </a>
                                                                        </cfif>
                                                                    </cfif>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <cfif !listFindNoCase("TRAINER,TEST", SESSION.USER_PROFILE)>
                                                        <cfif (listFindNoCase("1,2,3,4", get_tp.formation_id)) AND (listFindNoCase("1,2,10", get_tp.tp_status_id)) AND get_tp.method_id eq "1">
                                                            <span class="badge badge-pill border bg-light p-2 font-weight-normal">
                                                                <div class="d-flex">
                                                                    <div>
                                                                        <img src="./assets/img/unknown_male.png" width="40">
                                                                    </div>
                                                                    <div>
                                                                        <button class="btn btn-sm btn-link text-red btn_edit_trainer pb-0">#obj_translater.get_translate('btn_add')#</button>
                                                                    </div>
                                        ...
                                        <div class="d-flex justify-content-center align-items-center p-2">
                                            ...
                                            #obj_translater.get_translate('card_activity')#

                                            <cfif tp_scheduled_go neq "0">
                                            <span class="badge badge-pill text-dark border border-warning p-2 font-weight-normal mx-1" style="font-size:16px">
                                                <small>#obj_translater.get_translate('badge_planned_f_p')#</small>
                                                <strong>
                                                    #obj_lms.get_format_hms(toformat="#tp_scheduled_go#",unit="min")#
                                                </strong>
                                            </span>
                                            </cfif>

                                            <cfif tp_completed_go neq "0">
                                            <span class="badge badge-pill text-dark border border-success p-2 font-weight-normal mx-1" style="font-size:16px">
                                                <small>#obj_translater.get_translate('badge_completed_f_p')#</small>
                                                <strong>
                                                    #obj_lms.get_format_hms(toformat="#tp_completed_go#",unit="min")#
                                                </strong>
                                            </span>
                                            </cfif>

                                            <cfif tp_missed_go neq "0">
                                            <span class="badge badge-pill text-dark border border-danger p-2 font-weight-normal mx-1" style="font-size:16px">
                                                <small>#obj_translater.get_translate('badge_missed_f_p')#</small>
                                                <strong>
                                                    #obj_lms.get_format_hms(toformat="#tp_missed_go#",unit="min")#
                                                </strong>
                                            </span>
                                            </cfif>

                                            <cfif tp_cancelled_go neq "0">
                                            <span class="badge badge-pill text-dark border border-danger p-2 font-weight-normal mx-1" style="font-size:16px">
                                                <small>#obj_translater.get_translate('badge_cancelled_f_p')#</small>
                                                <strong>
                                                    #obj_lms.get_format_hms(toformat="#tp_cancelled_go#",unit="min")#
                                                </strong>
                                            </span>
                                            </cfif>

                                            <span class="badge badge-pill text-dark border border-info p-2 font-weight-normal mx-1" style="font-size:16px">
                                                <small>#obj_translater.get_translate('badge_remaining_f_p')#</small>
                                                <strong>
                                                    <cfif tp_remain_go neq "0">
                                                    #obj_lms.get_format_hms(toformat="#tp_remain_go#",unit="min")#
                                                    <cfelse>
                                                    #tp_remain_go#h
                                                    </cfif>
                                                </strong>
                ...
                <cfif get_tp.method_scheduler eq "scheduler">
                    ...
                    <div class="row mt-2">
                        <div class="col-md-12">          
                            ...
                            <cfif u_id neq 0 AND get_tp.method_id eq "1" AND (listFindNoCase("LEARNER,TEST,CS", SESSION.USER_PROFILE)) AND listfindnocase(SESSION.LIST_PT,get_tp.formation_code)>
                                <div class="row">
                                    <div class="col-md-12">
                                            ...
                                            <cfoutput group="lesson_id"> 
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-3">
                                                        ...
                                                        <img src="./assets/img_formation/#get_tp.formation_id#.png" width="28">

                                                        <span class="badge badge-pill bg-white border border-dark p-2 mt-2 font-weight-normal" style="font-size:14px"><i class="fal fa-clock"></i> #session_duration# min</span> 
                                                        
                                                        <cfif level_id neq "">
                                                            <span class="badge badge-pill bg-white border border-#level_css# p-2 mt-2 font-weight-normal" style="font-size:14px"><i class="fal fa-chart-bar"></i> #level_alias#</span> 
                                                        </cfif>
                                                        ...
                                                        <cfif origin_id neq "">
                                                            ...
                                                            <cfloop query="get_origin_id">
                                                                <span class="badge badge-pill bg-white border border-dark p-2 mt-2 font-weight-normal" style="font-size:14px">#origin_name#</span><br>
                                                            </cfloop>
                                                        </cfif>

                                                        
                                                        <cfif listfindnocase("10,11,12", get_tp.method_id)>
                                                            <span class="badge badge-pill bg-white border border-dark p-2 mt-2 font-weight-normal btn_edit_tpgroup cursored" id="group_#tp_id#_#lesson_id#" style="font-size:14px"><i class="fal fa-users"></i> #get_tp.method_name#</span> 
                                                        <cfelseif listfindnocase("12", get_tp.method_id)>
                                                            <span class="badge badge-pill bg-white border border-dark p-2 mt-2 font-weight-normal btn_edit_tpgroup cursored" id="group_#tp_id#_#lesson_id#" style="font-size:14px"><i class="fa-light fa-chalkboard-user"></i> #get_tp.method_name#</span> 
                                                        </cfif>
                                                        ...
                                                        <cfif mapping_id neq "">
                                                            ...
                                                            <div class="row mt-2">
                                                                ...
                                                                <cfquery name="get_mapping_grammar" datasource="#SESSION.BDDSOURCE#">
                                                                    ...
                                                                    <span class="badge badge-#css# font-weight-normal p-2" style="font-size:13px">#level# - #mapping_name#</span><br>
                                                                    </cfloop>
                                                                ...
                                                                <cfif status_id eq "1">
                                                                    ...
                                                                    <cfif listFindNoCase("CS,SALES,FINANCE,TRAINERMNG", SESSION.USER_PROFILE)>
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-md-4">
                                                                                    <div class="pull-right"><a href="./invite/invite_ics.cfm?l_id=#lesson_id#" class="" target="_blank">+iCal</a></div>
                                                                            </div>
                                                                        </div>
                                                                    <cfelse>
                                                                        <div align="center"><a href="#link_go#" target="_blank"><img src="./assets/img/invite_gg.gif"></a></div>
                                                    ...
                                                    <div class="col-sm-5 btn-grid" align="right">
                                                        <div class="equal-widths">
                                                            ...
                                                            <cfif sessionmaster_id neq "696" AND sessionmaster_id neq "697" AND sessionmaster_id neq "695" AND sessionmaster_id neq "694" AND sessionmaster_id neq "1181" AND sessionmaster_id neq "1182" AND sessionmaster_id neq "1183" AND sessionmaster_id neq "769" AND sessionmaster_id neq "1267" AND isdefined("SESSION.ACCESS_EL")>
                                                                <a type="button" class="btn btn-outline-info p-1" href="./learner_practice.cfm?sm_id=#sessionmaster_id#" style="min-height:82px !important;">e-Learning
                                                                    <br><cfif SESSION.LANG_CODE == "DE"> <br></cfif>
                                                                    <i class="fal fa-laptop fa-2x mt-2"></i></a>
                                                            </cfif>
...
$(document).ready(function() {
	...
	<cfif isdefined("tp_firstlesson")>
        $('##window_item_lg').modal({keyboard: true});
        $('##modal_title_lg').text("#encodeForJavaScript(trim(obj_translater.get_translate('js_modal_title_firstlesson')))#");
