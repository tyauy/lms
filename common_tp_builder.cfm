...
SELECT tc.*, sm.*, tp.*, tm.module_name, l.*, (SELECT COUNT(quiz_id) as quiz_id FROM lms_quiz WHERE sessionmaster_id = sm.sessionmaster_id) AS quiz_id
...
ORDER BY sm.level_id, tp.tpmaster_id ASC, sm.module_id
</cfquery>
					...
					<div class="card border-top border-info mr-3">
						<div class="card-body">
							...
							<div id="accordion">
								...
								<div>
									<button class="btn btn-#level_alias# btn-block" data-toggle="collapse" data-target="##tcat_#level_id#" aria-expanded="true">
									[ #obj_translater.get_translate('level')# #level_alias# ]
									</button>
								</div>
								
								<div id="tcat_#level_id#" class="collapse" data-parent="##accordion">
								
								<cfoutput group="tpmaster_id">
									<cfif not listFindNoCase("TRAINER", SESSION.USER_PROFILE) OR (listFindNoCase("TRAINER", SESSION.USER_PROFILE) AND tpmaster_id neq "1336" AND tpmaster_id neq "1337" AND tpmaster_id neq "1338" AND tpmaster_id neq "1339")>
									<div>
										<button class="btn btn-outline-#level_alias# btn-block text-left" data-toggle="collapse" data-target="##tp_#tpmaster_id#" aria-expanded="true">
										<!---[ #level_alias# ]---> #tpmaster_name# <!---#tpmaster_id#--->
										</button>
									</div>
									
									<div id="tp_#tpmaster_id#" class="collapse" data-parent="##tcat_#level_id#">
											...
											<cfoutput group="module_id">
												...
												<tr>	
													...
													<td width="300" class="sessionmaster_title">
														<cfif level_id neq "0" AND level_id neq ""><img src="./assets/img_level/#level_id#_plain.svg" width="25"></cfif> #sessionmaster_name#
													</td>
													<td width="120">
													<small>#__text_about# #sessionmaster_duration# m</small>
													</td>
													<td>
													<i style="cursor:pointer" class="fas fa-book text-#level_alias# btn_view_session" id="sm_#sessionmaster_id#" data-toggle="tooltip" data-placement="top" title="#__tooltip_material#"></i>
													</td>
													<td>
													<cfif sessionmaster_audio_bool eq "1">
													<i style="cursor:pointer" class="fas fa-volume-up text-#level_alias# btn_view_session" id="sm_#sessionmaster_id#" data-toggle="tooltip" data-placement="top" title="#__tooltip_audio_content#"></i>
													</cfif>
													</td>
													<td>
													<cfif sessionmaster_video_bool eq "1">
													<i style="cursor:pointer" class="fas fa-video text-#level_alias# btn_view_session" id="sm_#sessionmaster_id#" data-toggle="tooltip" data-placement="top" title="#__tooltip_video_content#"></i>
													</cfif>
													</td>
													<td>
													<cfif quiz_id neq "">
													<i style="cursor:pointer" class="fas fa-tasks text-#level_alias# btn_view_session" id="sm_#sessionmaster_id#" data-toggle="tooltip" data-placement="top" title="#__tooltip_quiz_content#"></i>
													</cfif>
													</td>
													<td align="right">
													<a href="##" class="btn btn-sm btn-#level_alias# add_line" id="STS_#sessionmaster_id#_#sessionmaster_cat_id#"><i class="fas fa-arrow-right"></i></a>
													</td>
												</tr>
												</cfoutput>
											</cfoutput>
