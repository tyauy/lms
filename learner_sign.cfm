				...
				<div class="col-md-12">
					...
					<div class="card border">
						<div class="card-body">
							...
							<h5 class="mb-2 text-dark" style="font-size:22px"><cfoutput>#obj_translater.get_translate('card_awaiting_signature')#</cfoutput></h5>
							<hr class="mt-0 border-red">

							<cfif get_lesson.recordcount neq "0">
							<div class="bg-light mt-3" role="alert">
								<div class="media">
