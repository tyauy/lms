...
WHERE provider_id = 1 AND pack_active = 1
</cfquery>
		...
		<cfset myxml = myxml&'
				<lieu-de-formation>
					<coordonnees numero="PARIS_DID">
						...
						<courriel>cpf@wefitgroup.com</courriel>
					</coordonnees>
				</lieu-de-formation>'>
...
<cfset myxml = myxml&'
				...
				<extras info="action">
					...
					<extras info="frais-pedagogiques">
						...
						<extra info="frais-ht">#xmlformat(pack_amount_ht)#</extra>
...
<cffile action="write" file="/home/www/wnotedev1/www/manager/lms/exporter/51068964900034_cpf.xml" charset="ISO-8859-1" output="#myxml#">